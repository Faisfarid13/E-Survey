...
<body>
    ...
    <div id="overlay" class="fixed top-0 left-0 w-full h-full bg-gray-900 opacity-60 z-50 transition-opacity duration-300 ease-in-out pointer-events-none z-40 hidden"></div>
    <div id="confirmation-modal" class="text-center md:w-max w-80 bg-white fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 rounded-lg border-solid border-2 border-grey shadow-md z-50 hidden">
        <div class="p-4 rounded-lg">
            ...
            <button id="confirm-submit" class="mt-2 px-6 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mx-2">Ya</button>
