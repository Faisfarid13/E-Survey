@extends('master')
@section('content')
 <div class="pt-20 bg-[#EBFFF6] pt-0 text-white rounded-b-3xl bg-cover bg-center drop-shadow-lg" style="background-image: url({{ asset('/asset/bgcoba2.png') }})">
  <div class="w-4/5 mx-auto">
    <div class="">
      <img class="pl-2 py-4" src="{{ asset('asset/logodkvfix.png') }}">
    </div>
    ...
    {{-- <h2 class="mb-14 md:text-[1.75rem] text-[1rem] font-bold tracking-tight leading-normal text-[#266C3E]">
...
<section id="Survei">
    ...
    <div class="border w-4/5 mx-auto p-3 rounded-lg hover:bg-[#EBFFF6] hover:shadow-lg bg-[#9ADED5] mb-5" >
  ...
  @endforeach
    ...
    <div class="flex items-center justify-center my-4">
      <button type="button" onclick="list()" class="btn btn-light drop-shadow-lg focus:outline-none hover:shadow-md text-grey-800 bg-[#9ADED5] hover:bg-[#EBFFF6] focus:ring-2 focus:ring-yellow-300 font-bold rounded-lg p-2 text-md px-5 py-2.5 mr-2 mb-2 mt-5 w-64 h-12 dark:focus:ring-yellow-900">Survei lebih lanjut</button>
    </div>
    <script>
