...
@section('content')
  {{-- jumbotron --}}
  <div class="bg-[#EBFFF6] bg-cover w-full bg-cover" style="background-image: url({{'asset/Frame.png'}})">
    <img src="{{asset('asset/gelombangpais2.png')}}" alt="" class="w-full z-40 border-0">
  </div>
